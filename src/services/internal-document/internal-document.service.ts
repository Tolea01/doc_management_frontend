...
import { IInternalDocument } from '../../types/document.types';

class InternalDocumentService {
  private BASE_URL: string = '/internal-documents';
  ...
  async getAll(
    ...
    const response: AxiosResponse<any, any> = await axiosWithAuth.get<IInternalDocument>(
      `${this.BASE_URL}/list`,
